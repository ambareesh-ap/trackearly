 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Xmoze for publication on ThemeForest
...
add_action( 'tgmpa_register', 'xmoze_register_required_plugins' );
 ...
 */
function xmoze_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			'name'      => 'Xmoze Helper',
			'slug'      => 'xmoze-helper',
			'source'	=> get_parent_theme_file_path('/inc/plugins/plugin-files/xmoze-helper.zip'),
	 ...
	 */
	$config = array(
		'id'           => 'xmoze',                 // Unique ID for hashing notices for multiple instances of TGMPA.
		'default_path' => '',                      // Default absolute path to bundled plugins.
		'menu'         => 'xmoze-install-plugins', // Menu slug.
