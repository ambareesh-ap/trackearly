<?php
$has_site_logo =   (!empty(xmoze_get_site_logo())) ? 'has-site-logo' : '';
?>
<header class="xmoze-header-area header-style-1">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12">
                <div class="xmoze-header-wrap">
                    <div class="site-branding <?php echo esc_attr($has_site_logo)  ?>">
                        <a href="<?php echo esc_url(home_url()) ?>">
                            <?php
                            printf("%s", xmoze_get_site_logo());
                            ?>
                        </a>
                    </div><!-- .site-branding -->
                    <div class="xmoze-menu-wrap">
                        <div class="xmoze-main-menu-wrap navbar menu-style-inline justify-content-end">
